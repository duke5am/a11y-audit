...
than typed from memory.
    ...
    python3 dump_axe_rules.py --out axe-rules-reference.json

The kit ships the output for axe-core 4.13.0 (``audit/axe-rules-reference.json``).
...
from crawl import AXE_CANDIDATES, annotate_violation, resolve_axe_path  # noqa: E402
